...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.epsilion_old = 0 # old epsilion value
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # decay function using a neg exponential
            self.epsilon = math.exp(-self.alpha*self.t)
            # new = (self.epsilion_old - 0.05)
            # self.epsilion = new
            self.t += 1
            # self.epsilion_old = new
            # self.epsilon = self.epsilon - 0.05 # modified from the forum
...
def run():
    ...
    #    * alpha   - continuous value for the learning rate, default is 0.5 #0.002
    ...
    sim = Simulator(env, update_delay=0.00, log_metrics=True, optimized=True, display=True)
    
    ##############
    # Run the simulator
    # Flags:
    #   tolerance  - epsilon tolerance before beginning testing, default is 0.05  #0.01
    #   n_test     - discrete number of testing trials to perform, default is 0
    sim.run(n_test=100, tolerance=0.01) # n_test = 100
